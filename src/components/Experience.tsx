...
const Experience = () => {
  const experiences = [
    ...
    },
    {
      ...
      achievements: [
        ...
        'Managing events, feedback, and issue resolution for 60+ students',
    ...
    },
    {
      ...
      achievements: [
        ...
        'Increased chapter engagement through strategic content planning'
      ]
    },
    {
      title: 'Coordinator',
  ...
  const certifications = [
    { name: 'Google Cloud Data Analytics', issuer: 'Google', year: '2024', level: 'Professional' },
    { name: 'Blockchain Applications', issuer: 'NPTEL', year: '2024', level: 'Elite' },
    { name: 'Cloud Computing', issuer: 'NPTEL', year: '2023', level: 'Elite' },
    { name: 'Programming in Java', issuer: 'NPTEL', year: '2024', level: 'Elite' },
    { name: 'Frontend Development', issuer: 'Great Learning', year: '2024', level: 'Professional' },
    { name: 'Foundations: Data, Data, Everywhere', issuer: 'Coursera', year: '2024', level: 'Professional' },
    { name: 'Japanese Language Culture I', issuer: 'NPTEL', year: '2023', level: 'Elite Silver' },
    { name: 'Japanese Language Culture II', issuer: 'NPTEL', year: '2023', level: 'Elite Silver' },
    { name: 'Business Japanese & Business Manner', issuer: 'NPTEL', year: '2023', level: 'Elite Silver' }
  ];
